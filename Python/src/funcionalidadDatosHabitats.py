...
en pantalla los datos de los diferentes hábitats del zoológico"""
    ...
    def consultar(self):
        # Se establece el mensaje con la cantidad de hábitats con los que se cuenta.
        ...
        for i in self.tabla.get_children():
            self.tabla.delete(i)
        # Ahora, se obtienen cada uno de los datos de los hábitats existentes para ser ingresados en la tabla por filas.
        for habitat in Administracion.getHabitats():
            # En caso que el hábitat no cuente con animales y por lo tanto getEspecie() retorne None, 
            # se mostrará como dato para dicho registro "Sin especie"
