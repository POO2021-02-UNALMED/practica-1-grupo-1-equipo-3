...
if __name__=="__main__":
	Vis1=Visitante("Jose",1,15)
	Vis2=Visitante("David",4,15)
	print(Visitante.getTotalVisitantes)
	print(Vis1.getPrecioBoleta)
	print(Vis2.getPrecioBoleta)
	print(Administracion.getVisitantes)
